...
$stmt_eventos = $conn->prepare("SELECT * FROM eventos ORDER BY fecha DESC LIMIT 4");
$stmt_eventos->execute();
$eventos = $stmt_eventos->fetchAll(PDO::FETCH_ASSOC);
?>

<!-- Hero Section - Fondo estático -->
<section id="inicio" class="hero" style="background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80') center/cover no-repeat;">
    <div class="container">
                    ...
                    <div class="event-card">
                        ...
                        <div class="event-info-container">
                            ...
                            <div class="event-button-container">
                                <a href="/evento/<?php echo htmlspecialchars($evento['slug']); ?>" class="btn-event-details">
                                    Más información
                                </a>
                            </div>
                        </div>
        ...
        <div class="services-grid">
            <div class="service-card glass-effect">
                ...
                <div class="service-cta">
                    <a href="https://wa.me/573015017283?text=Hola%20Luis%20Navas%20Producciones,%20quiero%20más%20información%20sobre%20Organización%20Integral" class="btn-service-details">
                        Más información
                    </a>
                </div>
            </div>
            ...
            <div class="service-card glass-effect">
                ...
                <div class="service-cta">
                    <a href="https://wa.me/573015017283?text=Hola%20Luis%20Navas%20Producciones,%20quiero%20más%20información%20sobre%20Logística%20de%20Eventos" class="btn-service-details">
                        Más información
                    </a>
                </div>
            </div>
            ...
            <div class="service-card glass-effect">
                ...
                <div class="service-cta">
                    <a href="https://wa.me/573015017283?text=Hola%20Luis%20Navas%20Producciones,%20quiero%20más%20información%20sobre%20Producción%20Musical" class="btn-service-details">
                        Más información
                    </a>
                </div>
            </div>
            ...
            <div class="service-card glass-effect">
                ...
                <div class="service-cta">
                    <a href="https://wa.me/573015017283?text=Hola%20Luis%20Navas%20Producciones,%20quiero%20más%20información%20sobre%20Abastecimiento%20Premium" class="btn-service-details">
                        Más información
                    </a>
                </div>
            </div>
